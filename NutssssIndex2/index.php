                ...
                <div class="pages-text" id="pages-text2">
                    <div class="pages-text-box">
                        ...
                        <ul class="giteeBoxUL">
                            ...
                            <li>
                                <div class="giteeBox-Title">
                                    <a target="_blank" href="<?php echo $UserInfo[$i]['namespace']['html_url'];?>"
                                        style="color: rgb(110, 110, 110);"><?php echo substr($UserInfo[$i]['human_name'], 0, strrpos($UserInfo[$i]['full_name'], '/'));?></a>
                                    /
                                    <a target="_blank"
                                        href="<?php echo substr($UserInfo[$i]['html_url'], 0, strrpos($UserInfo[$i]['html_url'], '.git'));?>"><?php echo substr($UserInfo[$i]['full_name'], strrpos($UserInfo[$i]['human_name'], '/') + 1);?></a>
                                    <div class="starBox">
                                        <i class="fa fa-star" aria-hidden="true"></i>
                                        <span class="star"><?php echo $UserInfo[$i]['stargazers_count'];?></span>
                                    </div>
                                </div>
                                <p class="giteeBox-Text"><?php echo $UserInfo[$i]['description'];?></p>
                                <p class="giteeBox-Time">
                                    最后更新：<?php echo substr($UserInfo[$i]['updated_at'], 0, strrpos($UserInfo[$i]['updated_at'], 'T'));?>
                                </p>
                                <a target="_blank"
                                    href="<?php echo substr($UserInfo[$i]['html_url'], 0, strrpos($UserInfo[$i]['html_url'], '.git'));?>"
                                    class="aClick show">查看</a>
                            </li>
                            <?php endfor;?>
                        </ul>
                    </div>
